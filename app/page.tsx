...
const FallingSkills = () => {
  const skills = [
    { name: 'Django', icon: '/icons/django.png', delay: 0 },
    { name: 'FastAPI', icon: '/icons/fastapi.png', delay: 0.5 },
    { name: 'Node.js', icon: '/icons/node.png', delay: 1 },
    { name: 'PostgreSQL', icon: '/icons/postgresql.png', delay: 1.5 },
    { name: 'MongoDB', icon: '/icons/mongodb.png', delay: 2 },
    { name: 'Redis', icon: '/icons/redis.png', delay: 2.5 },
    { name: 'Docker', icon: '/icons/docker.png', delay: 3 },
    { name: 'MySQL', icon: '/icons/mysql.png', delay: 3.5 },
    { name: 'Kafka', icon: '/icons/kafka.png', delay: 4 },
    { name: 'Nginx', icon: '/icons/nginx.png', delay: 4.5 },
    { name: 'Python', icon: '/icons/python.png', delay: 5 },
    { name: 'JavaScript', icon: '/icons/javascript.png', delay: 5.5 },
  ];

  return (
    <div className="relative w-72 h-80 md:w-96 md:h-[450px] overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-bg-darker/50 to-bg-darker"></div>
      {skills.map((skill, index) => (
        <motion.div
          key={skill.name}
          initial={{ y: -100, x: Math.random() * 250, opacity: 0, rotate: 0 }}
          animate={{
            y: [null, 500],
            opacity: [0, 1, 1, 0],
            rotate: [0, 360],
        ...
        >
          <div className="bg-bg-dark border-2 border-accent/30 rounded-xl p-3 backdrop-blur-sm hover:border-accent transition-colors shadow-lg">
            <img src={skill.icon} alt={skill.name} className="w-10 h-10 mb-1 object-contain" />
            <div className="text-xs font-bold text-accent whitespace-nowrap">{skill.name}</div>
          </div>
        </motion.div>
      ))}
    </div>
    ...
    >
      <div className="space-y-2">
        ...
        <h2 className="text-2xl md:text-3xl font-semibold">
          I'm a <span className="text-accent text-glow">Backend Developer</span>
        </h2>
      </div>
    ...
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
      ...
      >
        ...
        <p className="text-gray-400 leading-relaxed">
          ...
          With expertise in modern frameworks like Django, FastAPI, Flask, Node.js and automation with python, I specialize in designing
  ...
  <section id="skills" className="py-24 px-6 max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      <SkillCard
        title="Backend & API"
        icon={Server}
        skills={["Django & DRF", "FastAPI","Flask", "Node.js & Express"]}
      />
      <SkillCard
        title="Databases"
        icon={Database}
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <ProjectCard
          ...
          category="Management / Fastapi"
          image="/project_image/RH.jpg"
        />
        <ProjectCard
  ...
  return (
    <section id="contact" className="py-24 px-6 max-w-7xl mx-auto">
      ...
      <div className="max-w-3xl mx-auto">
        <form action="https://formsubmit.co/mushota09@gmail.com" method="POST" className="space-y-6">
